...
<div class="page-wrapper dashboard" id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="highchart-content" id="realtimechart" style="width: 100%; height: 500px;"></div>
        </div>
    </div>
...
<script data-main="/js/current-summary.js" src="/client/lib/requirejs/require.js"></script>
@endsection
